...
void loop() {
	...
	if(counter_speed < size_speed){
			arr_speed[counter_speed] = setpoint - temperature1; counter_speed++;}
	else {counter_speed = 0;arr_speed[counter_speed] = setpoint - temperature1;}
	speed = 0;
	Serial.print("speed t/min: ");
	if(counter_speed+1<size_speed)
		speed = (temperature1 - arr_speed[counter_speed+1])/60
	else
		speed = (temperature1 - arr_speed[0])/60
	Serial.print(speed);
	Serial.print(' ');
